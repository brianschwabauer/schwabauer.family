    ...
    <div class="details-grid">
      ...
      <aside class="info-card">
        ...
        <dl>
          ...
          <dd>
            <a
              href="https://www.google.com/maps/search/?api=1&query=South+Lake+Park+7601+W+86th+St+Overland+Park+KS+66212"
              target="_blank"
              rel="noopener"
            >
              South Lake Park
...
<style>
  ...
  .rsvp {
    ...
    background: linear-gradient(
      180deg,
      transparent,
      color-mix(in oklab, var(--c-paper-2) 70%, transparent)
    );
  }
  .rsvp-grid {
    display: grid;
